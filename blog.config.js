...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '贝思软件', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个全能的软件网站', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://550010.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '办公软件, 技术软件,视频软件,音乐软件', // 网站关键词 英文逗号隔开
